...
\noindent \begin{minipage}[c]{0.6\textwidth}
  \vspace {1cm}
\par Na diciplina de programação e desenvolvimento de banco de dados é apresentado as discentes a linguagem \textbf{SQL} \textit{Structured Query Language}\ref{fig:logo}, e para a maniopulação desta linguagem é propoto o software \textbf{MySQL da Workbench}
